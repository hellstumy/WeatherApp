  ...
  useEffect(() => {
    ...
    if (!weather) return <div className="loading_conteiner">
      <div className="loading"><span>L</span><span>o</span><span>a</span><span>d</span><span>i</span><span>n</span><span>g</span></div>
    </div>;
